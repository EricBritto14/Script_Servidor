...
#Fazer mais testes, mas acredito que está funcionando tdo caso alguém clique no programa e fique escrito Selecionado, e caso não clique também, ou caso clique e feche o programa
def tecla():
    while True:
